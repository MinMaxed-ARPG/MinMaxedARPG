namespace PLAYERTWO.ARPGProject
{
    public class CharacterEquipments
    {
        ...
        public ItemInstance initialShoulder;
        public ItemInstance initialNeck;
        public ItemInstance initialChest;
        public ItemInstance initialBack;
        public ItemInstance initialBelt;
        public ItemInstance initialRingLeft;
        public ItemInstance initialRingRight;
        ...
        public ItemInstance currentShoulder => m_items ? m_items.GetShoulder() : initialShoulder;
        public ItemInstance currentNeck => m_items ? m_items.GetNeck() : initialNeck;
        public ItemInstance currentChest => m_items ? m_items.GetChest() : initialChest;
        public ItemInstance currentBack => m_items ? m_items.GetBack() : initialBack;
        public ItemInstance currentBelt => m_items ? m_items.GetBelt() : initialBelt;
        public ItemInstance currentRingLeft => m_items ? m_items.GetRingLeft() : initialRingLeft;
        public ItemInstance currentRingRight => m_items ? m_items.GetRingRight() : initialRingRight;
        ...
        public virtual void InitializeEquipments(EntityItemManager items)
        {
            ...
            m_items.TryEquip(initialShoulder, ItemSlots.Shoulder);
