namespace PLAYERTWO.ARPGProject
{
    public partial class EntityItemManager
    {
        ...
        /// <summary>
        /// Returns the Item Instance of the item equipped on the shoulder slot.
        /// </summary>
        public virtual ItemInstance GetShoulder() => GetOrInitializeItem(ItemSlots.Shoulder);

        /// <summary>
        /// Returns the Item Instance of the item equipped on the Neck slot.
        /// </summary>
        public virtual ItemInstance GetNeck() => GetOrInitializeItem(ItemSlots.Neck);
        ...
        /// <summary>
        /// Returns the Item Instance of the item equipped on the back slot.
        /// </summary>
        public virtual ItemInstance GetBack() => GetOrInitializeItem(ItemSlots.Back);

        /// <summary>
        /// Returns the Item Instance of the item equipped on the belt slot.
        /// </summary>
        public virtual ItemInstance GetBelt() => GetOrInitializeItem(ItemSlots.Belt);

        /// <summary>
        /// Returns the Item Instance of the item equipped on the Left Ring slot.
        /// </summary>
        public virtual ItemInstance GetRingLeft() => GetOrInitializeItem(ItemSlots.RingLeft);

        /// <summary>
        /// Returns the Item Instance of the item equipped on the Right Ring slot.
        /// </summary>
        public virtual ItemInstance GetRingRight() => GetOrInitializeItem(ItemSlots.RingRight);
