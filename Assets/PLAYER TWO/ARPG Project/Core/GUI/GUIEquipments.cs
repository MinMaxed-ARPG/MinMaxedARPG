...
namespace PLAYERTWO.ARPGProject
{
    ...
    public class GUIEquipments : MonoBehaviour
    {
        ...
        [Tooltip("Reference to the GUI Equipment Slot that corresponds to the shoulder slot.")]
        public GUIEquipmentSlot shoulderSlot;

        [Tooltip("Reference to the GUI Equipment Slot that corresponds to the neck slot.")]
        public GUIEquipmentSlot neckSlot;

        [Tooltip("Reference to the GUI Equipment Slot that corresponds to the chest slot.")]
        public GUIEquipmentSlot chestSlot;

        [Tooltip("Reference to the GUI Equipment Slot that corresponds to the back slot.")]
        public GUIEquipmentSlot backSlot;

        [Tooltip("Reference to the GUI Equipment Slot that corresponds to the belt slot.")]
        public GUIEquipmentSlot beltSlot;

        [Tooltip("Reference to the GUI Equipment Slot that corresponds to the left ring slot.")]
        public GUIEquipmentSlot ringleftSlot;

        [Tooltip("Reference to the GUI Equipment Slot that corresponds to the right ring slot.")]
        public GUIEquipmentSlot ringrightSlot;
        ...
        protected virtual void InitializeEquipments()
        {
            ...
            Equip(equipments.GetShoulder(), shoulderSlot);
            Equip(equipments.GetNeck(), neckSlot);
            Equip(equipments.GetChest(), chestSlot);
            Equip(equipments.GetBack(), backSlot);
            Equip(equipments.GetBelt(), beltSlot);
            Equip(equipments.GetRingLeft(), ringleftSlot);
            Equip(equipments.GetRingRight(), ringrightSlot);
